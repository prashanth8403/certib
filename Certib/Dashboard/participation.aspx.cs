...
{
    public partial class participationcertificate : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["CertificateWizard"] == "2")
            {
                try
                {
                    ...
                    ParticipationCertificate certificate = new ParticipationCertificate(certificate_id, FullName.Text, Email.Text, Usn.Text, Participation.Text, Remarks.Text, "2017", department_selection.SelectedValue);
